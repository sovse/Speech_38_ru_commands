...
model.load_state_dict(torch.load('resnet18_3_128_400.model'))
model.eval()
...
def int_prepare_fn():
    melspec_tr = torchaudio.transforms.MelSpectrogram(
        ...
        n_fft=128 * 5,  # args.n_fft,
        hop_length=160,  # args.hop_length,
        win_length=400,
        normalized=False,
    )
